...
----------------------------------------------------------------------------------------------------------------------------------
 mvn archetype:generate -DgroupId=com.javatpoint -DartifactId=testWebApp -DarchetypeArtifactId=maven-archetype-webapp -DinteractiveMode=false
 ...
 http://<host-name>:<portnumber>/projectname, for example: http://localhost:8080/testWebApp
